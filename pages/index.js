...
*
* Name: Muhammad F. Khan Student ID: 113-524-201 Date: 2023-03-01
*
********************************************************************************/
...
export default function index() {
  return (
    <>
      <Image src='https://upload.wikimedia.org/wikipedia/commons/3/30/Metropolitan_Museum_of_Art_%28The_Met%29_-_Central_Park%2C_NYC.jpg' alt='A pic of the muesum' fluid rounded />
      <br />
      <br />
      <Container>
        <Row>
